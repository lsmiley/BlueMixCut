...
namespace SizingToolNew2.Controllers
{
    ...
    public class SizingsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Bands1 = new SelectList(db.LaborDeliverys, "LaborDeliveryId", "RegionNumber");
            ...
            ViewBag.Country = new SelectList(db.AvProducts, "AvProductId", "ProductDesc");// items;
