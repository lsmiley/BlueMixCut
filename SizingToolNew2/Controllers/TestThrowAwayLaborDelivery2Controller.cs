...
{
    public class TestThrowAwayLaborDelivery2Controller : Controller
    {
        private SizingDbContext db = new SizingDbContext();

        // GET: TestThrowAwayLaborDelivery2
        public async Task<ActionResult> Index()
        {
            return View(await db.LaborDeliverys.ToListAsync());
        }

        // GET: TestThrowAwayLaborDelivery2/Details/5
        ...
        // GET: TestThrowAwayLaborDelivery2/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TestThrowAwayLaborDelivery2/Create
        ...
        // GET: TestThrowAwayLaborDelivery2/Edit/5
        ...
        // POST: TestThrowAwayLaborDelivery2/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: TestThrowAwayLaborDelivery2/Delete/5
        ...
        // POST: TestThrowAwayLaborDelivery2/Delete/5
