...
namespace SizingToolNew2.Controllers
{
    ...
    public class TeamsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TeamId,TeamName,TeamDesc,TeamNote")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TeamId,TeamName,TeamDesc,TeamNote")] Team team)
        {
            if (ModelState.IsValid)
            {
