...
namespace SizingToolNew2.Controllers
{
    ...
    public class SizingUserDashboardController : Controller
    {
        ...
        // GET: SizingUserDashboard/GetSizings/5
        [AuthLog(Roles = "Administrator, Solution Manager, Solution Architect")]
        ...
        [AllowAnonymous]
            // GET: SizingUserDashboard/GeneratePDF
        ...
        public ActionResult GetLaborByID1(string id)
        {
            ...
            //According id to query the database and get the relevant values.
            var query = db.LaborDeliverys.Where(c => c.LaborDeliveryId == LaborId1).Select(c => new { LaborDeliveryId = c.LaborDeliveryId, RegionNumber = c.RegionNumber, Regions = c.Regions, DeliveryOption = c.DeliveryOption, CurrencyType = c.CurrencyType, DefaultFTE_Year = c.DefaultFTE_Year, WorkWeek = c.WorkWeek, Band3Percentage = c.Band3Percentage, Band4Percentage = c.Band4Percentage, Band5Percentage = c.Band5Percentage, Band6Percentage = c.Band6Percentage, Band7Percentage = c.Band7Percentage, Band8Percentage = c.Band8Percentage, Band9Percentage = c.Band9Percentage }).FirstOrDefault();
            return Json(query, JsonRequestBehavior.AllowGet);
        }
        [AuthLog(Roles = "Administrator, Solution Manager, Solution Architect, Sizer, Viewer")]
        public ActionResult GetLaborByID2(string id)
        {
            ...
            //According id to query the database and get the relevant values.
            var query = db.LaborDeliverys.Where(c => c.LaborDeliveryId == LaborId2).Select(c => new { LaborDeliveryId = c.LaborDeliveryId, RegionNumber = c.RegionNumber, Regions = c.Regions, DeliveryOption = c.DeliveryOption, CurrencyType = c.CurrencyType, DefaultFTE_Year = c.DefaultFTE_Year, Band3Percentage = c.Band3Percentage, Band4Percentage = c.Band4Percentage, Band5Percentage = c.Band5Percentage, Band6Percentage = c.Band6Percentage, Band7Percentage = c.Band7Percentage, Band8Percentage = c.Band8Percentage, Band9Percentage = c.Band9Percentage }).FirstOrDefault();
            return Json(query, JsonRequestBehavior.AllowGet);
        }
        [AuthLog(Roles = "Administrator, Solution Manager, Solution Architect, Sizer, Viewer")]
        public ActionResult GetLaborByID3(string id)
        {
            ...
            //According id to query the database and get the relevant values.
            var query = db.LaborDeliverys.Where(c => c.LaborDeliveryId == LaborId3).Select(c => new { LaborDeliveryId = c.LaborDeliveryId, RegionNumber = c.RegionNumber, Regions = c.Regions, DeliveryOption = c.DeliveryOption, CurrencyType = c.CurrencyType, DefaultFTE_Year = c.DefaultFTE_Year, Band3Percentage = c.Band3Percentage, Band4Percentage = c.Band4Percentage, Band5Percentage = c.Band5Percentage, Band6Percentage = c.Band6Percentage, Band7Percentage = c.Band7Percentage, Band8Percentage = c.Band8Percentage, Band9Percentage = c.Band9Percentage }).FirstOrDefault();
            return Json(query, JsonRequestBehavior.AllowGet);
        }
        [AuthLog(Roles = "Administrator, Solution Manager, Solution Architect, Sizer, Viewer")]
        public ActionResult GetLaborByID4(string id)
        {
            ...
            //According id to query the database and get the relevant values.
            var query = db.LaborDeliverys.Where(c => c.LaborDeliveryId == LaborId4).Select(c => new { LaborDeliveryId = c.LaborDeliveryId, RegionNumber = c.RegionNumber, Regions = c.Regions, DeliveryOption = c.DeliveryOption, CurrencyType = c.CurrencyType, DefaultFTE_Year = c.DefaultFTE_Year, Band3Percentage = c.Band3Percentage, Band4Percentage = c.Band4Percentage, Band5Percentage = c.Band5Percentage, Band6Percentage = c.Band6Percentage, Band7Percentage = c.Band7Percentage, Band8Percentage = c.Band8Percentage, Band9Percentage = c.Band9Percentage }).FirstOrDefault();
            return Json(query, JsonRequestBehavior.AllowGet);
        }
